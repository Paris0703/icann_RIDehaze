...
netG_B2A.load_state_dict(torch.load(r"C:\Users\Admin\Desktop\paper2\paper2Code\weight\441_2.5307, _1.2617, .pth"))
...
dataloader = DataLoader(PairClearDepth("test"),batch_size=batchSize, shuffle=True, num_workers=n_cpu,pin_memory=True,drop_last=True)
...
if __name__ == "__main__":
        ...
        for i, batch in loop:
            ...
            tensor_example2 = recovered_Clear[:1, :3, :, :].squeeze(0) * 255  # (tensor_example2 - tensor_example2.min()) / (tensor_example2.max() - tensor_example2.min()) * 255
